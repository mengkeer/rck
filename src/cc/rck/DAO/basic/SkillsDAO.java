...
public class SkillsDAO extends BaseHibernateDAO {
	...
	public Skills findById(java.lang.Integer id) {
		...
		try {
			Skills instance = (Skills) getSession().get("cc.rck.model.Skills",
					id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Skills instance) {
		log.debug("finding Skills instance by example");
		try {
			List results = getSession().createCriteria("cc.rck.model.Skills")
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Skills instance with property: " + propertyName
				+ ", value: " + value);
		try {
			String queryString = "from Skills as model where model."
					+ propertyName + "= ?";
