 ...
 * 
 * @see cc.rck.model.Projects
 * @author MyEclipse Persistence Tools
 */
public class ProjectsDAO extends BaseHibernateDAO {
	...
	public void save(Projects transientInstance) {
	...
	public Projects findById(java.lang.Integer id) {
		log.debug("getting Projects instance with id: " + id);
		try {
			Projects instance = (Projects) getSession().get(
					"cc.rck.model.Projects", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Projects instance) {
		...
		try {
			List results = getSession().createCriteria("cc.rck.model.Projects")
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Projects instance with property: " + propertyName
				+ ", value: " + value);
		try {
			String queryString = "from Projects as model where model."
					+ propertyName + "= ?";
	...
	public List findAll() {
		...
		try {
			String queryString = "from Projects";
			Query queryObject = getSession().createQuery(queryString);
			return queryObject.list();
		} catch (RuntimeException re) {
	...
	public Projects merge(Projects detachedInstance) {
		...
		try {
			Projects result = (Projects) getSession().merge(detachedInstance);
